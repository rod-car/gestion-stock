...
class NouveauArticleRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "reference" => ["required", "unique:articles,reference", "sometimes", "min:2", "max:255"],
            "designation" => ["required", "unique:articles,designation", "sometimes", "min:2", "max:255"],
