...
class ArticleController extends Controller
{
    ...
    public function getDepotArticles(?Depot $depot = null)
    {
        $depotArticle = DepotArticle::query()
            ...
            ->selectRaw("articles.designation as designation")
            ->selectRaw("articles.unite as unite")
            ->selectRaw("articles.id as article_id")
            ->selectRaw("depot_articles.depot_id as depot_id")
            ->selectRaw("depot_articles.bon as bon")
