...
class CreateCommandesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('commandes', function (Blueprint $table) {
            ...
            $table->unsignedSmallInteger('type')->comment('Type de commande: 1 - devis, 2 - Commande proprement dit');
            $table->date('date');
            $table->integer('validite')->nullable()->comment('Validité du devis en nombre de jour');
            ...
            $table->integer('status')->default(1)->comment('Status du devis: 1 - Valide');
            $table->timestamps();
