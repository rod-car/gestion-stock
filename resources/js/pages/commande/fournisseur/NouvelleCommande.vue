...
export default {
    ...
    setup(){
        ...
        /**
         * Appelé quand le champ de fournisseur change
         *
        ...
        */
        const setNumeroCommande = async () => {
            await Commande.getKey({ type: 2, appro: true })
        ...
        const hasError = computed(() => {
            if (Commande.errors.value.fournisseur && Commande.errors.value.fournisseur.length > 0) return true
            return false
        })
        ...
        return {
            form, nombre_article, Commande, Fournisseur, Article, Flash, Config,
