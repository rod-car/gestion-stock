    ...
    <div class="card mt-3">
        <div class="card-header d-flex justify-content-between align-items-center bg-white pt-3 pb-3">
            ...
            <div class="d-flex justify-content-between">
                ...
                <router-link v-if="!Commande.loading.value && Commande.entity.value.id" :to="{ name: 'commande.fournisseur.modifier', params: { id: Commande.entity.value.id }}" class="btn btn-warning me-2"><i class="fa fa-pencil me-2"></i>Modifier</router-link>
        ...
        <div class="card-body">
            ...
            <div v-if="!Commande.loading.value && Commande.entity.value.frs" class="row mb-5">
                <div class="col-xl-6 d-flex align-items-start flex-column justify-content-center">
                    <h6>Fournisseur: {{ Commande.entity.value.frs.nom }}</h6>
                    <h6>{{ Commande.entity.value.frs.adresse }}</h6>
                    <h6>Téléphone: {{ Commande.entity.value.frs.contact }}</h6>
                </div>
