        ...
        <div class="card me-3">
            <div class="card-header bg-white p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 v-if="!loading" class="text-info">Gerer les personnelles de l'entrepôt N° {{ depot.id }}</h5>
                            ...
                            <div v-if="!loading">
                                ...
                                <ul v-else class="list-group">
                                    <li class="list-group-item list-group-item-action">
                                        Aucune personnelles qui travaillent dans cet entrepôt
                                    </li>
                                </ul>
                            </div>
                            <ul v-else class="list-group">
...
export default {
    ...
    setup() {
        return {
            depot, loading, updating, success, personnelles,
