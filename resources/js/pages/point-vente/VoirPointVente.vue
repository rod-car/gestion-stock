        ...
        <div class="card me-3">
            <div class="card-header bg-white p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 v-if="!loading" class="text-muted">Point de vente N° {{ depot.id }}</h5>
                    <Skeletor v-else width="50%" height="30" style="border-radius: 5px" />

                    <div class="d-flex justify-content-end">
                        <router-link v-if="$can('edit_point_vente') && depot.id" :to="{ name: 'point-de-vente.modifier', params: { id: depot.id }}" class="btn btn-warning text-white me-2">
                            <i class="fa fa-pencil me-2"></i>Modifier
                        </router-link>
                        <router-link v-if="$can('add_point_vente')" to="/point-de-vente/nouveau" class="btn btn-secondary me-2">
                    ...
                    <div class="col-xl-12 d-flex justify-content-between p-0">
                        ...
                        <div class="shadow shadow-sm p-3 w-100 ms-3">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <router-link v-if="depot.id" :to="{ name: 'point-de-vente.gerer-responsables', params: { id: depot.id }}" class="btn btn-info text-white">
                        ...
                        <div class="d-flex justify-content-between p-0">
                            <div class="me-2 shadow shadow-sm w-100 p-3">
                                <div class="mb-3 d-flex justify-content-between align-items-center">
                                    <h5 class="text-muted">Les articles dans ce point de vente</h5>
                            ...
                            <div class="ms-2 shadow shadow-sm w-100 p-3">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="text-muted">Tous personnelles de ce point de vente</h5>
                                    <router-link class="btn btn-info btn-sm text-white" v-if="depot.id" :to="{ name: 'point-de-vente.gerer-personnelles', params: { id: depot.id }}"><i class="fa fa-pencil me-2"></i>Mettre a jour</router-link>
                                </div>
                                <div v-if="!loading">
                                    ...
                                    <ul v-else class="list-group">
                                        <li class="list-group-item list-group-item-action">
                                            Aucune personnel pour ce point de vente
                                        </li>
                                    </ul>
                                </div>
