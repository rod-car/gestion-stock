        ...
        <div class="card me-3">
            <div class="card-header bg-white p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 v-if="!Depot.loading.value" class="text-info">Gerer les responsables du point de vente N° {{ Depot.entity.value.id }}</h5>
                    <Skeletor v-else width="50%" height="30" style="border-radius: 5px" />

                    <router-link v-if="$can('view_point_vente')" to="/point-de-vente/liste" class="btn btn-primary me-2"><i class="fa fa-list me-2"></i>Liste des point de vente</router-link>
                </div>
            </div>
