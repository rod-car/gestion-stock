        ...
        <div class="card me-3">
            <div class="card-header bg-white p-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <router-link to="/fournisseur/categorie/nouveau" class="btn btn-primary"><i class="fa fa-plus me-2"></i>Ajouter un nouveau</router-link>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody v-else-if="categories.length > 0">
                        <tr v-for="(categorie, index) in categories" v-bind:key="categorie.id">
                            ...
                            <td class="d-flex justify-content-center">
                                <router-link v-if="true" :to="{ name: 'fournisseur.categorie.modifier', params: { id: categorie.id }}" class="btn btn-primary btn-sm me-2"><i class="fa fa-edit"></i></router-link>
...
export default {
    ...
    mounted() {
        getCategories(2) // Recuperer les categories de fournisseur
    },
