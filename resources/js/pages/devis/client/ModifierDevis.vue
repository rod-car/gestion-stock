        ...
        <div class="card me-3">
            <div class="card-header bg-white p-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <router-link to="/devis/client/liste" class="btn btn-primary"><i class="fa fa-list me-2"></i>Liste des deviss</router-link>
                </div>
            </div>

            <div class="card-body">
                <DevisFormComponent v-if="!Devis.loading.value" :nouveau="false" :appro="false" :devis="Devis.entity.value" />
