    ...
    <div class="card mt-3">
        <div class="card-header d-flex justify-content-between align-items-center bg-white pt-3 pb-3">
            ...
            <div class="d-flex justify-content-between">
                ...
                <router-link v-if="!Devis.loading.value && Devis.entity.value.id" :to="{ name: 'devis.client.modifier', params: { id: Devis.entity.value.id }}" class="btn btn-warning me-2"><i class="fa fa-pencil me-2"></i>Modifier</router-link>
        ...
        <div class="card-body">
            ...
            <div v-if="!Devis.loading.value && Devis.entity.value.cl" class="row mb-5">
                <div class="col-xl-6 d-flex align-items-start flex-column justify-content-center">
                    <h6>Client: {{ Devis.entity.value.cl.nom }}</h6>
                    <h6>{{ Devis.entity.value.cl.adresse }}</h6>
                    <h6>Téléphone: {{ Devis.entity.value.cl.contact }}</h6>
                </div>
