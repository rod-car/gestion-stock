                ...
                <div class="row">
                    <div class="col-xl-6 mb-3" :class="Devis.loading.value === true ? 'd-flex align-items-end' : ''">
                        <Input v-if="Devis.loading.value === false" v-model="form.numero"
                            :error="Devis.errors.value.numero" disabled>Numéro du dévis</Input>
                    ...
                    <div class="col-xl-6 mb-3">
                        ...
                        <MultiSelect v-bind:class="hasError ? 'border-danger' : ''" label="nom" valueProp="id"
                    ...
                    <div class="col-xl-6">
                        <Input type="number" v-model="form.validite" :error="Devis.errors.value.validite"
                            required>Validité du dévis (en Jour)</Input>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-xl-12">
                <div class="d-flex justify-content-between mb-4">
                    ...
                    <button v-else @click="creerArticle" type="button" class="btn btn-primary"><i
                            class="fa fa-plus me-2"></i>Créer une nouvelle</button>
                </div>
                <div class="row">
                    <div class="col-xl-12">
...
export default {
    components: {
        Input, SaveBtn, Alert, Datepicker, MultiSelect, Skeletor, NouveauArticleComponent, NouveauFournisseurComponent,
    },
    setup() {
        ...
        return {
            Devis, Fournisseur, Article, Flash, Config, creerArticle, creationArticle, articleCree, creationFrs, frsCree, creerFrs,
        }
    },
    data() {
        return {
