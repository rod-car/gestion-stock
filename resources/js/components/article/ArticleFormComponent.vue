<template>
    <form action="" method="post">
        <div class="row mb-3">
            <div class="col-xl-2">
                <h6 class="text-primary">Donées de base</h6>
            </div>
            <div class="col-xl-10">
                <div class="row">
                    ...
                    <div class="col-xl-12 mb-3">
                        <Input v-model="form.description" type="textarea" :error="Article.errors.value.description" :required="false">Description</Input>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-5 d-none">
            <div class="col-xl-2">
                <h6 class="text-primary">Donées de planification</h6>
            </div>
            <div class="col-xl-10">
                <div class="row">
                    <div class="col-xl-6">
                        <Input v-model="form.unite" type="number" :error="Article.errors.value.unite" :required="false">Stock minimum</Input>
                    </div>
                    <div class="col-xl-6">
                        <Input v-model="form.unite" type="number" :error="Article.errors.value.unite" :required="false">Stock maximum</Input>
                    </div>
                    <div class="col-xl-6">
                        <Input v-model="form.unite" type="number" :error="Article.errors.value.unite" :required="false">Stock de securité</Input>
                    </div>
                    <div class="col-xl-6">
                        <Input v-model="form.unite" type="number" :error="Article.errors.value.unite" :required="false">Stock d'alerte</Input>
                    </div>
                </div>
            </div>
        </div>
